...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['President'];
  const customerRoles: string[] = ['In Charge Teacher'];
  const tenantRoles: string[] = ['Delegate'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `RISMUN CLUB`;
  const tenantName = `Delegate`;
